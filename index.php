...
<div class="bg-secondary p-4" style="opacity: 0.90;">
    <div id="carouselId" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <?php 
                ...
                {
            ?>
            <div class="carousel-item bg-gray <?php if($no == '1'){ echo 'active';}?>">
                <img src="assets/image/<?= $isi['gambar'];?>" alt="First slide" 
                class="img-fluid" style="object-fit:scale-down;width:100%;height:500px;">
            </div>
            <?php $no++;}?>
        </div>
            ...
            <div class="card" style="background-color:#90ADC6;">
                <div class="card-body">
                    ...
                    <form method="post" action="koneksi/proses.php?id=login" >
                        <center><h5 class="card-title " style="color: #FAD02C;">Login</h5></center>
