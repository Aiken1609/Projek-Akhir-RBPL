 ...
 */
    ...
    {
        echo '<script>window.location="index.php";alert("Harap login !");</script>';
    }
    $id = $_GET['id'];
...
<div class="row">
    <div class="col-sm-4">
        <div class="card">
            ...
            <?php }?>
            <li class="list-group-item bg-info text-white"><i class="fa fa-check"></i> Include Helm dan Jas Hujan</li>
         ...
         <div class="card">
           <div class="card-body">
               <form method="post" action="koneksi/proses.php?id=booking">
                    ...
                    <div class="form-group">
                      <label for="">Identitas Tambahan</label>
                      <input type="file" name="identitas tambahan" id="" required class="form-control" placeholder="Indetitas tambahan Anda">
                    </div> 
                    <div class="form-group">
