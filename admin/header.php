 ...
 */
    ...
    if(!empty($_SESSION['USER']['level'] == 'admin')){ 
        ...
        echo '<script>window.location="../index.php";alert("Login Khusus Admin !");</script>';
    }
...
<html lang="en">
  ...
  <body style="background-color: #E9EAEC;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #90ADC6;">
        <a class="navbar-brand" href="<?php echo $url;?>admin/" style="color:#1D213B;"><b>Admin Panel</b></a>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item <?php if($title_web == 'Dashboard'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/" style="color:#1D213B;">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item <?php if($title_web == 'User'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/user/index.php" style="color:#1D213B;">User / Pelanggan</a>
                </li>
                ...
                <?php if($title_web == 'Edit Motor'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/motor/motor.php" style="color:#1D213B;">Daftar Motor</a>
                </li>
                <li class="nav-item <?php if($title_web == 'Daftar Booking'){ echo 'active';}?>
                <?php if($title_web == 'Konfirmasi'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/booking/booking.php" style="color:#1D213B;">Daftar Booking</a>
                </li>
                <li class="nav-item <?php if($title_web == 'Peminjaman'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/peminjaman/peminjaman.php" style="color:#1D213B;">Peminjaman / Pengembalian</a>
                </li>
                <li class="nav-item <?php if($title_web == 'Track'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/track/track.php" style="color:#1D213B;">Track motor</a>
                </li>
            </ul>
